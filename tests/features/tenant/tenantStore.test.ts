...
describe('tenantStore 状态流转', () => {
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], '初始状态: current=null, list=[], loading=false', () => {
  ...
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'fetchTenants 成功后 list 填充', async () => {
  ...
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'fetchTenants 网络错误后 error 填充', async () => {
  ...
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'fetchTenant(id) 成功后 current 填充', async () => {
  ...
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'fetchTenant(id) 不存在时 error 填充', async () => {
  ...
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'clearError 清除 error', async () => {
    await useTenantStore.getState().fetchTenant('nonexistent')
  ...
  // —— ch43：平台租户管理（只增不改）——
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'createTenant 成功后新租户添加到 list 头部', async () => {
  ...
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'createTenant 网络错误后 error 填充', async () => {
  ...
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'updateTenant 成功后 list 中对应项更新', async () => {
  ...
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'updateTenant 网络错误后 error 填充', async () => {
  ...
  fnTest(["M01.F01.I03","M01.F01.I05","M01.F01.I10"], 'deleteTenant 网络错误后 error 填充', async () => {
