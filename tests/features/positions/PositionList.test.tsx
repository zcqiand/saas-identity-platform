...
const FIDS = ["M02.F03.I01","M02.F03.I02","M02.F03.I03"] as const
...
describe('PositionList', () => {
  fnTest([...FIDS], 'mount 后拉取并渲染岗位列表', async () => {
    render(<PositionList />)
